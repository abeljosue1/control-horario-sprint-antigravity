...
1.  **Clonar el repositorio**:
    ```bash
    git clone <[URL_DEL_REPOSITORIO](https://github.com/abeljosue1/control-horario-sprint-antigravity)>
    ```
...
- **Trello**: [[Link al tablero Trello del equipo](https://trello.com/b/X9jlMO2p/practicas)]
